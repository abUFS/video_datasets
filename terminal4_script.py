#!/usr/bin/env python3
"""
Script para baixar e processar Terminal4
"""
...
def main():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        temp_video = os.path.join(temp_dir, "terminal4_temp.%(ext)s")
        ...
        temp_cut = os.path.join(temp_dir, "terminal4_cut.mkv")
